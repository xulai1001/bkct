...
label init_items():
    ...
    python:
        ...
        mizuki_kimono = Item(name = "Mizuki's Kimono", target = 'MC', type = IT_Story, pic = 'Kimono.webp', template = False, rank = 1, rarity = "S", price = 0, pic_dir="dress", description = "A kimono left behind by Mizuki Ike, the mysterious eldest Kunoichi.", hidden_effect = True).get_instance()
...
#                       Item(name = "Steel Makibishi", target = 'MC', type = IT_Story, pic = 'steel makibishi.webp', template = False, rank = 3, rarity = "S", price = 1500, description = "Slows down Kunoichi movements during ninja hunt (large effect).", hidden_effect = True),
    ...
    ### TEMPLATE ITEMS ###
        ...
        template_items =   [
                            ...
                            Item(name = 'Apple', target = 'girl', type = IT_Food, pic = 'Apple.webp', template = True, rank = 1, max_rank = 6, rarity = 1, charges = 1, price = 50, effects = (Effect('change', 'beauty', 5, duration=10), Effect('instant', 'heal', 1, 0.5)), description =  "An apple a day keeps the doctor away."),
...
label init_furniture():
    ...
    python:
        ...
        all_furniture = [
            ...
            Furniture('Basic painting', type='Decoration', pic='Decorative painting.webp', rank=1, chapter=1, cost=[('wood', 1), ('dye', 1), ('leather', 1), ], duration=0, effects=[Effect("allow", "laborers", 1, scope="brothel")], ),
            ...
            Furniture('Shepherd outfit', type='Utility', pic='Shepherd outfit.webp', rank=1, chapter=1, cost=[('wood', 2), ('leather', 6), ], duration=0, upgrade='Basic outfit', effects=[Effect("special", "advertising power", 2, scope="brothel")], ),
            ...
            Furniture('Fence', type='Utility', pic='Fence.webp', rank=1, chapter=1, cost=[('wood', 4), ('leather', 4), ], duration=0, upgrade='Basic door', effects=[Effect("boost", "security", 0.1, scope="brothel")], ),
            ...
            Furniture('Buckets', type='Utility', pic='Buckets.webp', rank=1, chapter=1, cost=[('wood', 6), ('leather', 2), ], duration=0, upgrade='Basic broom', effects=[Effect("boost", "maintenance", 0.25, scope="brothel")], ),
            ...
            Furniture('Simple safe', type='Utility', pic='safe1.webp', rank=1, chapter=1, cost=[('wood', 4), ('dye', 2), ('leather', 4), ], duration=3, effects=[Effect("special", "safe", 3000, scope="brothel")]),
