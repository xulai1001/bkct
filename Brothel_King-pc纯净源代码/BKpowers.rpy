init python:
    ...
    def init_powers(): # Initiates all objects and values for evil powers
        ...
        evpower_list =  [
                            ...
                            EvilPower(name='Blind obedience', type='Silver', power='obedience', target='conduit', effects=[Effect("change", "obedience target", -30), Effect("change", "all sex acts requirements", -15)], short_description='She is less likely to refuse working or training', mojo_cost=[('yellow', 3)], sanity_cost=3, duration=3, activation_limit="girl"),
                            ...
                            EvilPower(name='Mulligan', type='Bronze', power='mulligan', target='MC', short_description='Discard hand and redraw power cards', mojo_cost=[('green', 2), ('blue', 2)], sanity_cost=1),
        ...
        evpower_super_list = [
                                ...
                                EvilSuperPower(name='Mulligan', type='Bronze', power='mulligan', target='MC', effects=[Effect("change", "evil power cards", 2)], short_description='Discard hand and redraw with +2 extra cards', mojo_cost=[('green', 3), ('blue', 3)], sanity_cost=2),
