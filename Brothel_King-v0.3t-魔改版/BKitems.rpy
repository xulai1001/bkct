...
label init_items():
    ...
    python:
        ...
        all_items = [
                    ...
                    Item(name = _('White flower'), target = 'girl', type = IT_Flower, pic = 'White flower.webp', template = False, rank = 1, max_rank = 5, rarity = "F", price = 75, effects = (Effect('flower', 'white', 1), ), description ="白百合花象征着纯洁的爱情，别用你肮脏的思想玷污它！", hidden_effect = True),
                    Item(name = _('Yellow flower'), target = 'girl', type = IT_Flower, pic = 'Yellow flower.webp', template = False, rank = 1, max_rank = 5, rarity = "F", price = 75, effects = (Effect('flower', 'yellow', 1), ), description ="康乃馨能够驱逐病痛和悲伤，用它来抚慰少女受伤的心灵吧！", hidden_effect = True),
                    Item(name = _('Red flower'), target = 'girl', type = IT_Flower, pic = 'Red flower.webp', template = False, rank = 1, max_rank = 5, rarity = "F", price = 75, effects = (Effect('flower', 'red', 1), ), description ="玫瑰花可以用来泡浴，酿酒，香薰....难道你要用它表白？", hidden_effect = True),
                    Item(name = _('Green flower'), target = 'girl', type = IT_Flower, pic = 'Green flower.webp', template = False, rank = 1, max_rank = 5, rarity = "F", price = 75, effects = (Effect('flower', 'green', 1), ), description ="小小的绣球花可以戴在女孩的发髻旁，别有韵味。", hidden_effect = True),
                    Item(name = _('Blue flower'), target = 'girl', type = IT_Flower, pic = 'Blue flower.webp', template = False, rank = 1, max_rank = 5, rarity = "F", price = 75, effects = (Effect('flower', 'blue', 1), ), description ="矢车菊被风吹起时，就像自由的小鸟，自由是无价之宝。", hidden_effect = True),
                    Item(name = _('Orange flower'), target = 'girl', type = IT_Flower, pic = 'Orange flower.webp', template = False, rank = 1, max_rank = 5, rarity = "F", price = 75, effects = (Effect('flower', 'orange', 1), ), description ="郁金香被大面积地种植于农田中，微风轻拂~香飘十里。", hidden_effect = True),
                    Item(name = _('Purple flower'), target = 'girl', type = IT_Flower, pic = 'Purple flower.webp', template = False, rank = 1, max_rank = 5, rarity = "F", price = 75, effects = (Effect('flower', 'purple', 1), ), description ="紫罗兰代表了约定与等待，你是个守约的人吗？", hidden_effect = True),
                    Item(name = _('Pink flower'), target = 'girl', type = IT_Flower, pic = 'Pink flower.webp', template = False, rank = 1, max_rank = 5, rarity = "F", price = 75, effects = (Effect('flower', 'pink', 1), ), description ="芙蓉很适合那些含苞待放的少女们，爱恋之心逐渐生根发芽。", hidden_effect = True),
                    Item(name = _('Black flower'), target = 'girl', type = IT_Flower, pic = 'Black flower.webp', template = False, rank = 1, max_rank = 5, rarity = "F", price = 75, effects = (Effect('flower', 'black', 1), ), description ="曼陀罗象征着女性的自主与独立，她们勇敢、坚强。", hidden_effect = True),
                    ]
        ...
        billboard = Furniture(_('Clockwork billboard'), type='Furnishing', pic='billboard.webp', rank=2, chapter=2, cost=[('wood', 40), ('dye', 25), ('leather', 10)], duration=5, effects=[Effect("special", "advanced advertising", 1, scope="brothel")], base_description="这个华丽的广告牌能吸引许多人的注意。可以解锁高级广告设置。") #  Unlocks advanced advertising settings
...
#                       Item(name = _("Steel Makibishi"), target = 'MC', type = IT_Story, pic = 'steel makibishi.webp', template = False, rank = 3, rarity = "S", price = 1500, description =__("Slows down Kunoichi movements during ninja hunt (large effect)."), hidden_effect = True),
    ...
    ### TEMPLATE ITEMS ###
        ...
        template_items =   [
                            ...
                            Item(name = '羽毛内衣®', target = 'girl', type = IT_Dress, pic=random.choice([ '羽毛内衣 (1).webp', '羽毛内衣 (2).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 500 , effects = (Effect('change', 'libido', 5), Effect('change', 'service', 5), ), description = "用好看的羽毛制作而成的内衣，可能会有点痒。"),
                            Item(name = '珍珠内衣®', target = 'girl', type = IT_Dress, pic=random.choice([ '珍珠内衣 (1).webp', '珍珠内衣 (2).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 500 , effects = (Effect('change', 'sensitivity', 5), Effect('change', 'sex', 5), ), description = "用串联的珍珠挡住私密的部位，小珍珠挡得住大珍珠吗？"),
                            Item(name = '渔网内衣®', target = 'girl', type = IT_Dress, pic=random.choice([ '渔网内衣 (1).webp', '渔网内衣 (2).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 500 , effects = (Effect('change', 'constitution', 5), Effect('change', 'anal', 5), ), description = "知名探险家贝尔格里斯曾用这种内衣捕捞到了一条大鱼，质量可靠。"),
                            Item(name = '透明内衣®', target = 'girl', type = IT_Dress, pic=random.choice([ '透明内衣 (1).webp', '透明内衣 (2).webp', '透明内衣 (3).webp', '透明内衣 (4).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 500 , effects = (Effect('change', 'obedience', 5), Effect('change', 'fetish', 5), ), description = "这和没穿又有什么区别呢？可能是摸上去的质感不同吧。"),
                            
                            Item(name = '可撕内衣®', target = 'girl', type = IT_Dress, pic=random.choice([ '可撕内衣 (1).webp', '可撕内衣 (2).webp', '可撕内衣 (3).webp', '可撕内衣 (4).webp', '可撕内衣 (5).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 750 , effects = (Effect('change', 'libido', 5), Effect('change', 'sensitivity', 5), ), description = "设计师在特别的部位选用了特别的面料，方便行事。就是用完了得重新买。"),
                            Item(name = '蕾丝内衣®', target = 'girl', type = IT_Dress, pic=random.choice([ '蕾丝内衣 (1).webp', '蕾丝内衣 (2).webp', '蕾丝内衣 (3).webp', '蕾丝内衣 (4).webp', '蕾丝内衣 (5).webp', '蕾丝内衣 (6).webp', '蕾丝内衣 (7).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 750 , effects = (Effect('change', 'constitution', 5), Effect('change', 'obedience', 5), ), description = "这种贴身的丝滑而又柔软的内衣，饱受女士和男士好评。"),
                            Item(name = '网纱内衣®', target = 'girl', type = IT_Dress, pic=random.choice([ '网纱内衣 (1).webp', '网纱内衣 (2).webp', '网纱内衣 (3).webp', '网纱内衣 (4).webp', '网纱内衣 (5).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 750 , effects = (Effect('change', 'sex', 5), Effect('change', 'anal', 5), ), description = "多么贴心的设计，方便你把手从各个位置插进去。"),
                            Item(name = '亮片内衣®', target = 'girl', type = IT_Dress, pic=random.choice([ '亮片内衣 (1).webp', '亮片内衣 (2).webp', '亮片内衣 (3).webp', '亮片内衣 (4).webp', '亮片内衣 (5).webp', '亮片内衣 (6).webp', '亮片内衣 (7).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 750 , effects = (Effect('change', 'service', 5), Effect('change', 'fetish', 5), ), description = "闪亮的亮片在灯光下是那么耀眼，这会让女孩更加光彩动人。"),
                            
                            Item(name = '护士制服®', target = 'girl', type = IT_Dress, pic=random.choice([ '护士制服 (1).webp', '护士制服 (2).webp']), template = True, rank = 2, max_rank = 6, rarity = 1, price = 800 , effects = (Effect('change', 'charm', 10), ), description = "这次轮到你给护士“打针”了。"),
                            Item(name = '奶牛装®', target = 'girl', type = IT_Dress, pic=random.choice([ '奶牛装.webp']), template = True, rank = 2, max_rank = 6, rarity = 1, price = 800 , effects = (Effect('change', 'beauty', 10), ), description = "沉甸甸的果实悬挂在胸前，她需要一位熟练的挤奶工帮忙释放压力。"),
                            Item(name = '赛车女郎®', target = 'girl', type = IT_Dress, pic=random.choice([ '赛车女郎.webp']), template = True, rank = 2, max_rank = 6, rarity = 1, price = 800 , effects = (Effect('change', 'body', 10), ), description = "三、二、一，出发！什么？你被她的车灯给晃住了？"),
                            Item(name = '教师制服®', target = 'girl', type = IT_Dress, pic=random.choice([ '教师制服 (1).webp', '教师制服 (2).webp']), template = True, rank = 2, max_rank = 6, rarity = 1, price = 800 , effects = (Effect('change', 'refinement', 10), ), description = "家庭教师要给你上生理课了哦~"),
                            
                            Item(name = '裸体围裙®', target = 'girl', type = IT_Dress, pic=random.choice([ '裸体围裙.webp']), template = True, rank = 2, max_rank = 6, rarity = 1, price = 900 , effects = (Effect('change', 'libido', 10), ), description = "在做饭的时候不要在背后打扰她，至少，先把火关了。"),
                            Item(name = '乳首夹®', target = 'girl', type = IT_Dress, pic=random.choice([ '乳首夹.webp']), template = True, rank = 2, max_rank = 6, rarity = 1, price = 900 , effects = (Effect('change', 'constitution', 10), ), description = "这能使乳首始终保持挺立。"),
                            Item(name = '眼罩®', target = 'girl', type = IT_Dress, pic=random.choice([ '眼罩.webp']), template = True, rank = 2, max_rank = 6, rarity = 1, price = 900 , effects = (Effect('change', 'sensitivity', 10), ), description = "人在失去视觉时触觉会变得更加敏感。"),
                            Item(name = '蕾丝内裤®', target = 'girl', type = IT_Dress, pic=random.choice([ '蕾丝内裤 (1).webp', '蕾丝内裤 (2).webp', '蕾丝内裤 (3).webp', '蕾丝内裤 (4).webp']), template = True, rank = 2, max_rank = 6, rarity = 1, price = 900 , effects = (Effect('change', 'obedience', 10), ), description = "透气透光的蕾丝设计，遮盖住了神秘的森林。"),

                            Item(name = '丝袜®', target = 'girl', type = IT_Dress, pic=random.choice([ '丝袜 (1).webp', '丝袜 (2).webp']), template = True, rank = 2, max_rank = 6, rarity = 2, price = 1200 , effects = (Effect('change', 'service', 10), ), description = "不管黑丝白丝，答应我，别脱下来好吗？"),
                            Item(name = '乳贴®', target = 'girl', type = IT_Dress, pic=random.choice([ '乳贴 (1).webp', '乳贴 (2).webp', '乳贴 (3).webp', '乳贴 (4).webp', '乳贴 (5).webp', '乳贴 (6).webp', '乳贴 (7).webp', '乳贴 (8).webp']), template = True, rank = 2, max_rank = 6, rarity = 2, price = 1200 , effects = (Effect('change', 'sex', 10), ), description = "创口贴，胶带，贴纸....小技巧：乳头挺立时更容易撕下来。"),
                            Item(name = '绑带®', target = 'girl', type = IT_Dress, pic=random.choice([ '绑带 (1).webp', '绑带 (2).webp', '绑带 (3).webp', '绑带 (4).webp', '绑带 (5).webp', '绑带 (6).webp', '绑带 (7).webp']), template = True, rank = 2, max_rank = 6, rarity = 2, price = 1200 , effects = (Effect('change', 'anal', 10), ), description = "紧紧的缠在胸前，等待有缘人释放被束缚的巨峰。"),
                            Item(name = '浴巾®', target = 'girl', type = IT_Dress, pic=random.choice([ '浴巾 (1).webp', '浴巾 (2).webp', '浴巾 (3).webp']), template = True, rank = 2, max_rank = 6, rarity = 2, price = 1200 , effects = (Effect('change', 'fetish', 10), ), description = "特制浴巾，表面的活性绒毛接触到皮肤上能给你触电般的快感。"),
                            
                            Item(name = '睡袍®', target = 'girl', type = IT_Dress, pic=random.choice([ '睡袍.webp']), template = True, rank = 2, max_rank = 6, rarity = 3, price = 1500 , effects = (Effect('change', 'beauty', 5), Effect('change', 'charm', 10), Effect('change', 'refinement', 5), Effect('change', 'body', 5), Effect('special', 'lucky', 1), ), description = "林品如同款睡衣，既然要追求刺激，那就贯彻到底吧！"),
                            Item(name = '婚纱®', target = 'girl', type = IT_Dress, pic=random.choice([ '婚纱 (1).webp', '婚纱 (2).webp', '婚纱 (3).webp', '婚纱 (4).webp', '婚纱 (5).webp']), template = True, rank = 2, max_rank = 6, rarity = 3, price = 1500 , effects = (Effect('change', 'beauty', 10), Effect('change', 'charm', 5), Effect('change', 'refinement', 5), Effect('change', 'body', 5), Effect('special', 'lucky', 1), ), description = "有的人喜欢中式，有的人喜欢西式，不过到了床上反正都要脱掉，又有什么区别呢？"),
                            Item(name = '晚礼服®', target = 'girl', type = IT_Dress, pic=random.choice([ '晚礼服 (1).webp', '晚礼服 (2).webp', '晚礼服 (3).webp', '晚礼服 (4).webp', '晚礼服 (5).webp']), template = True, rank = 2, max_rank = 6, rarity = 3, price = 1500 , effects = (Effect('change', 'beauty', 5), Effect('change', 'charm', 5), Effect('change', 'refinement', 5), Effect('change', 'body', 10), Effect('special', 'lucky', 1), ), description = "选用顶级的面料，尽享奢华，成为宴会上的一道风景线吧！"),
                            Item(name = '轻纱®', target = 'girl', type = IT_Dress, pic=random.choice([ '轻纱 (1).webp', '轻纱 (2).webp', '轻纱 (3).webp', '轻纱 (4).webp', '轻纱 (5).webp', '轻纱 (6).webp']), template = True, rank = 2, max_rank = 6, rarity = 3, price = 1500 , effects = (Effect('change', 'beauty', 5), Effect('change', 'charm', 5), Effect('change', 'refinement', 10), Effect('change', 'body', 5), Effect('special', 'lucky', 1), ), description = "透过轻纱能够隐约看见她诱人的胴体，如果刮起一阵风的话...."),
                            
                            Item(name = '乳首跳蛋®', target = 'girl', type = IT_Dress, pic=random.choice([ '乳首跳蛋 (1).webp', '乳首跳蛋 (2).webp', '乳首跳蛋 (3).webp']), template = True, rank = 3, max_rank = 6, rarity = 4, price = 3000 , effects = (Effect('change', 'service', 10), Effect('change', 'sex', 5), Effect('change', 'anal', 5), Effect('change', 'fetish', 5), Effect('special', 'lucky', 2), ), description = "嗡——嗡——，放心，不是你的电话响了。"),
                            Item(name = '肥皂泡泡®', target = 'girl', type = IT_Dress, pic=random.choice([ '肥皂泡泡 (1).webp', '肥皂泡泡 (2).webp']), template = True, rank = 3, max_rank = 6, rarity = 4, price = 3000 , effects = (Effect('change', 'service', 5), Effect('change', 'sex', 10), Effect('change', 'anal', 5), Effect('change', 'fetish', 5), Effect('special', 'lucky', 2), ), description = "这种特别调制的泡沫可以维持很久而不消散。"),
                            Item(name = '魅魔淫纹®', target = 'girl', type = IT_Dress, pic=random.choice([ '魅魔淫纹 (1).webp', '魅魔淫纹 (2).webp']), template = True, rank = 3, max_rank = 6, rarity = 4, price = 3000 , effects = (Effect('change', 'service', 5), Effect('change', 'sex', 5), Effect('change', 'anal', 10), Effect('change', 'fetish', 5), Effect('special', 'lucky', 2), ), description = "将这种纹章贴纸贴在小腹上，你会得到魅魔的祝福的。"),
                            Item(name = '人体彩绘®', target = 'girl', type = IT_Dress, pic=random.choice([ '人体彩绘 (1).webp', '人体彩绘 (2).webp']), template = True, rank = 3, max_rank = 6, rarity = 4, price = 3000 , effects = (Effect('change', 'service', 5), Effect('change', 'sex', 5), Effect('change', 'anal', 5), Effect('change', 'fetish', 10), Effect('special', 'lucky', 2), ), description = "对于暴露狂来说既能满足裸体的需求，又不至于让别人不好意思看。"),
                            
                            Item(name = '开胸装®', target = 'girl', type = IT_Dress, pic=random.choice([ '开胸装 (1).webp', '开胸装 (2).webp', '开胸装 (3).webp', '开胸装 (4).webp']), template = True, rank = 3, max_rank = 6, rarity = 3, price = 2400 , effects = (Effect('change', 'libido', 10), Effect('change', 'sensitivity', 5), Effect('change', 'obedience', 5), Effect('change', 'constitution', 5), ), description = "适合哺乳期妈妈的着装，谁还不是个小宝贝了~"),
                            Item(name = '男友衬衫®', target = 'girl', type = IT_Dress, pic=random.choice([ '男友衬衫 (1).webp', '男友衬衫 (2).webp', '男友衬衫 (3).webp', '男友衬衫 (4).webp']), template = True, rank = 3, max_rank = 6, rarity = 3, price = 2400 , effects = (Effect('change', 'libido', 5), Effect('change', 'sensitivity', 10), Effect('change', 'obedience', 5), Effect('change', 'constitution', 5), ), description = "重点是尺寸不合身，不管是尺寸过大还是过小，都别有一番风味。"),
                            Item(name = '裹身裙®', target = 'girl', type = IT_Dress, pic=random.choice([ '裹身裙 (1).webp', '裹身裙 (2).webp', '裹身裙 (3).webp', '裹身裙 (4).webp', '裹身裙 (5).webp', '裹身裙 (6).webp', '裹身裙 (7).webp', '裹身裙 (8).webp']), template = True, rank = 3, max_rank = 6, rarity = 3, price = 2400 , effects = (Effect('change', 'libido', 5), Effect('change', 'sensitivity', 5), Effect('change', 'obedience', 10), Effect('change', 'constitution', 5), ), description = "紧紧的裹住身体，勾勒出诱人的身材曲线。"),
                            Item(name = '露背装®', target = 'girl', type = IT_Dress, pic=random.choice([ '露背装 (1).webp', '露背装 (2).webp', '露背装 (3).webp', '露背装 (4).webp', '露背装 (5).webp', '露背装 (6).webp', '露背装 (7).webp']), template = True, rank = 3, max_rank = 6, rarity = 3, price = 2400 , effects = (Effect('change', 'libido', 5), Effect('change', 'sensitivity', 5), Effect('change', 'obedience', 5), Effect('change', 'constitution', 10), ), description = "背后凉飕飕的，是不是有人在说坏话？"),
                            
                            Item(name = '低领上衣®', target = 'girl', type = IT_Dress, pic=random.choice([ '低领上衣 (1).webp', '低领上衣 (2).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 800 , effects = (Effect('boost', 'beauty gains', 0.08), ), description = "尽情地展示你的事业线吧~"),
                            Item(name = '高叉装®', target = 'girl', type = IT_Dress, pic=random.choice([ '高叉装 (1).webp', '高叉装 (2).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 800 , effects = (Effect('boost', 'body gains', 0.08), ), description = "跳健美操时很方便活动，做其他事也很方便。"),
                            Item(name = '针织毛衣®', target = 'girl', type = IT_Dress, pic=random.choice([ '针织毛衣 (1).webp', '针织毛衣 (2).webp', '针织毛衣 (3).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 800 , effects = (Effect('boost', 'charm gains', 0.08), ), description = "劈里啪啦~这不是电魔法，这是静电。"),
                            Item(name = '超短裙®', target = 'girl', type = IT_Dress, pic=random.choice([ '超短裙 (1).webp', '超短裙 (2).webp', '超短裙 (3).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 800 , effects = (Effect('boost', 'refinement gains', 0.08), ), description = "只要稍微弯一点腰，就能看到....答应我，别穿安全裤好吗？"),

                            Item(name = '吊带裙®', target = 'girl', type = IT_Dress, pic=random.choice([ '吊带裙 (1).webp', '吊带裙 (2).webp', '吊带裙 (3).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 1000 , effects = (Effect('boost', 'libido gains', 0.08), ), description = "吊带裙适合老肩巨滑的女人。"),
                            Item(name = '高叉裙®', target = 'girl', type = IT_Dress, pic=random.choice([ '高叉裙 (1).webp', '高叉裙 (2).webp', '高叉裙 (3).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 1000 , effects = (Effect('boost', 'obedience gains', 0.08), ), description = "可以方便的掀起前面和后面，我是说掀起来装东西。"),
                            Item(name = '浴衣®', target = 'girl', type = IT_Dress, pic=random.choice([ '浴衣 (1).webp', '浴衣 (2).webp', '浴衣 (3).webp', '浴衣 (4).webp', '浴衣 (5).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 1000 , effects = (Effect('boost', 'sensitivity gains', 0.08), ), description = "美人出浴，宽松的浴衣能给她最贴心的呵护。"),
                            Item(name = '牛仔裤®', target = 'girl', type = IT_Dress, pic=random.choice([ '牛仔裤 (1).webp', '牛仔裤 (2).webp', '牛仔裤 (3).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 1000 , effects = (Effect('boost', 'constitution gains', 0.08), ), description = "结实耐磨的面料，也是让女人减肥的动力之一。"),
                            
                            Item(name = '啦啦队服®', target = 'girl', type = IT_Dress, pic=random.choice([ '啦啦队服 (1).webp', '啦啦队服 (2).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 450 , effects = (Effect('change', 'charm', 5), Effect('change', 'beauty', 5), ), description = "一二三，加油！能够唤起雄性的动力。"),
                            Item(name = '圣诞装®', target = 'girl', type = IT_Dress, pic=random.choice([ '圣诞装 (1).webp', '圣诞装 (2).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 450 , effects = (Effect('change', 'beauty', 5), Effect('change', 'body', 5), ), description = "圣诞节快乐！不听话的坏孩子可没有礼物哦~"),
                            Item(name = '兔女郎®', target = 'girl', type = IT_Dress, pic=random.choice([ '兔女郎 (1).webp', '兔女郎 (2).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 450 , effects = (Effect('change', 'body', 5), Effect('change', 'refinement', 5), ), description = "长耳朵，短尾巴，渔网袜。记得带上你的大萝卜，她最爱吃了。"),
                            Item(name = '巫女服®', target = 'girl', type = IT_Dress, pic=random.choice([ '巫女服 (1).webp', '巫女服 (2).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 450 , effects = (Effect('change', 'refinement', 5), Effect('change', 'charm', 5), ), description = "巫女祭祀时穿的衣服，祈福时漏的越多效果越好。"),
                            
                            Item(name = '旗袍®', target = 'girl', type = IT_Dress, pic=random.choice([ '旗袍.webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 500 , effects = (Effect('change', 'libido', 5), Effect('change', 'body', 5), ), description = "东方传统服饰，尽享雍容华贵。"),
                            Item(name = '汉服®', target = 'girl', type = IT_Dress, pic=random.choice([ '汉服 (1).webp', '汉服 (2).webp', '汉服 (3).webp', '汉服 (4).webp', '汉服 (5).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 500 , effects = (Effect('change', 'charm', 5), Effect('change', 'sensitivity', 5), ), description = "如果你有耐心一层又一层地拨开洋葱，那这衣服一定适合你。"),
                            Item(name = '瑜伽服®', target = 'girl', type = IT_Dress, pic=random.choice([ '瑜伽服.webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 500 , effects = (Effect('change', 'beauty', 5), Effect('change', 'obedience', 5), ), description = "拜拜甜甜圈，燃烧你的卡路里！"),
                            Item(name = '胶衣®', target = 'girl', type = IT_Dress, pic=random.choice([ '胶衣 (1).webp', '胶衣 (2).webp', '胶衣 (3).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 500 , effects = (Effect('change', 'refinement', 5), Effect('change', 'constitution', 5), ), description = "贴身的胶衣，搜查官的标配，谁知道里面有多闷。"),
                            
                            Item(name = '警察制服®', target = 'girl', type = IT_Dress, pic=random.choice([ '警察制服 (1).webp', '警察制服 (2).webp', '警察制服 (3).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 750 , effects = (Effect('change', 'beauty', 5), Effect('change', 'charm', 5), Effect('change', 'body', 5), Effect('change', 'refinement', -5), ), description = "不许动，举起手来！把你的武器...哦，你的武器看起来很危险。"),
                            Item(name = '空姐制服®', target = 'girl', type = IT_Dress, pic=random.choice([ '空姐制服 (1).webp', '空姐制服 (2).webp', '空姐制服 (3).webp', '空姐制服 (4).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 750 , effects = (Effect('change', 'beauty', 5), Effect('change', 'charm', 5), Effect('change', 'refinement', 5), Effect('change', 'body', -5), ), description = "欢迎乘坐泽恩航空，尊贵的VIP客户，请问需要特殊服务吗？"),
                            Item(name = '女仆装®', target = 'girl', type = IT_Dress, pic=random.choice([ '女仆装 (1).webp', '女仆装 (2).webp', '女仆装 (3).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 750 , effects = (Effect('change', '-beauty', 5), Effect('change', 'charm', 5), Effect('change', 'refinement', 5), Effect('change', 'body', 5), ), description = "这身衣服打扫卫生似乎并不方便，不过主人喜欢就够了。"),
                            Item(name = 'JK服®', target = 'girl', type = IT_Dress, pic=random.choice([ 'JK服 (1).webp', 'JK服 (2).webp', 'JK服 (3).webp', 'JK服 (4).webp', 'JK服 (5).webp', 'JK服 (6).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 750 , effects = (Effect('change', 'beauty', 5), Effect('change', '-charm', 5), Effect('change', 'refinement', 5), Effect('change', 'body', 5), ), description = "未成年的衣服还得是成年人穿起来才有那味~"),

                            Item(name = '舞女服®', target = 'girl', type = IT_Dress, pic=random.choice([ '舞女服 (1).webp', '舞女服 (2).webp', '舞女服 (3).webp', '舞女服 (4).webp', '舞女服 (5).webp', '舞女服 (6).webp', '舞女服 (7).webp', '舞女服 (8).webp', '舞女服 (9).webp', '舞女服 (10).webp', '舞女服 (11).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 800 , effects = (Effect('change', 'libido', -5), Effect('change', 'sensitivity', 5), Effect('change', 'obedience', 5), Effect('change', 'constitution', 5), ), description = "翩若惊鸿，宛如游龙，伴随着音乐的节奏，身上的衣物越来越少。"),
                            Item(name = '泳装®', target = 'girl', type = IT_Dress, pic=random.choice([ '泳装 (1).webp', '泳装 (2).webp', '泳装 (3).webp', '泳装 (4).webp', '泳装 (5).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 800 , effects = (Effect('change', 'libido', 5), Effect('change', 'sensitivity', -5), Effect('change', 'obedience', 5), Effect('change', 'constitution', 5), ), description = "竞技泳装，学校泳装，比基尼，总有一款适合你。"),
                            Item(name = '领带®', target = 'girl', type = IT_Dress, pic=random.choice([ '领带 (1).webp', '领带 (2).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 800 , effects = (Effect('change', 'libido', 5), Effect('change', 'sensitivity', 5), Effect('change', 'obedience', 5), Effect('change', 'constitution', -5), ), description = "领带什么都挡不住，不过可以拽着当链子。"),
                            Item(name = '肚兜®', target = 'girl', type = IT_Dress, pic=random.choice([ '肚兜 (1).webp', '肚兜 (2).webp', '肚兜 (3).webp', '肚兜 (4).webp']), template = True, rank = 1, max_rank = 6, rarity = 1, price = 800 , effects = (Effect('change', 'libido', 5), Effect('change', 'sensitivity', 5), Effect('change', 'obedience', -5), Effect('change', 'constitution', 5), ), description = "东方传统女性的贴身衣物，上面绣着小鸭子，啊不对，是鸳鸯。"),
