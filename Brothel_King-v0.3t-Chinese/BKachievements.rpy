...
init python:
    ...
    achievement_list = [
                        Achievement(_("新人上路"), __("观看新手教程。"), pic="portrait.webp", pic_path="NPC/Sill/", target="intro"),
                        ...
                        Achievement(_("第一章：狼狈为奸"), __("You helped a bunch of thugs fuck a helpless woman in the sewers."), pic="portrait naked.webp", pic_path="NPC/Sewer girl/", target="c1 gang", multi=2),
...
#                         Achievement("Bedded: The Adventurer", "You had sex with Scarlet.", pic="portrait.webp", pic_path="NPC/Jobgirl/", target="h jobgirl"), # Event not ready yet?
                        ...
                        Achievement(_("Hokuto No Chin-Chin"), __("Reach level %s as a Warrior."), pic="warrior.webp", pic_path="UI/", level_nb=5, target="战士", requirements={1 : 5, 2 : 10, 3 : 15, 4 : 20, 5 : 25}, multi=5),
                        Achievement(_("Klaatu Barada Nikto"), __("Reach level %s as a Wizard."), pic="wizard.webp", pic_path="UI/", level_nb=5, target="法师", requirements={1 : 5, 2 : 10, 3 : 15, 4 : 20, 5 : 25}, multi=5),
                        Achievement(_("Gold Finger"), __("Reach level %s as a Trader."), pic="trader.webp", pic_path="UI/", level_nb=5, target="商人", requirements={1 : 5, 2 : 10, 3 : 15, 4 : 20, 5 : 25}, multi=5),
